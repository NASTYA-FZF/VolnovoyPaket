...
// VolnovoyPaket.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CVolnovoyPaketApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CVolnovoyPaketApp

CVolnovoyPaketApp::CVolnovoyPaketApp()
{
...
// Единственный объект CVolnovoyPaketApp

CVolnovoyPaketApp theApp;


// Инициализация CVolnovoyPaketApp

BOOL CVolnovoyPaketApp::InitInstance()
{
